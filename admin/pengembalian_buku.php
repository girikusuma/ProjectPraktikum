          ...
          <section class="connectedSortable">
            <table class="table">
              ...
              <?php
                  ...
                  $next_page = $page + 1;
                  $prev_page = $page - 1;
                  $result = $connection->query("SELECT * FROM tb_pinjam");
                  $total_records = mysqli_num_rows($result);
                  $total_no_page = ceil($total_records/$total_data_page);
                  $second_last = $total_no_page - 1;
                  $resultPerPage = $connection->query("SELECT * FROM tb_pinjam LIMIT $offset,$total_data_page");
              ?>
              <?php $no = $offset+1; ?>
              <?php  while($row = mysqli_fetch_assoc($resultPerPage)) : ?>
                  <tr>
                      ...
                      <td>
                        <a href="kembali_buku.php?id=<?=$row['id_pinjam']?>"><button type="button" class="btn btn-warning">Kembalikan</button></a>
                      </td>
