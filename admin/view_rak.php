          ...
          <section class="connectedSortable">
            <table class="table">
              ...
              <?php
                  ...
                  $next_page = $page + 1;
                  $prev_page = $page - 1;
                  $result = $connection->query("SELECT * FROM tb_rak");
                  $total_records = mysqli_num_rows($result);
                  $total_no_page = ceil($total_records/$total_data_page);
                  $second_last = $total_no_page - 1;
                  $resultPerPage = $connection->query("SELECT * FROM tb_rak
              ...
              <?php  while($row = mysqli_fetch_assoc($resultPerPage)) : ?>
                  <tr>
                      ...
                      <td><?= $row['nama_rak']; ?></td>
                      <td>
                        <a href="page_edit_rak.php?id=<?=$row['id_rak']?>"><button type="button" class="btn btn-warning">Edit</button></a>
                        <a href="hapus_rak.php?id=<?=$row['id_rak']?>"><button type="button" class="btn btn-danger">Hapus</button></a>
                      </td>
                  </tr>
                  <?php $no++; ?>
                  <?php endwhile; ?>
