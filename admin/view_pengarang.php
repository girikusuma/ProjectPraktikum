  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Pengarang</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="container-fluid"> 
              <a href="page_tambah_pengarang.php">
          ...
          <section class="connectedSortable">
            <table class="table">
              ...
              <?php
                  ...
                  $next_page = $page + 1;
                  $prev_page = $page - 1;
                  $result = $connection->query("SELECT * FROM tb_pengarang");
                  $total_records = mysqli_num_rows($result);
                  $total_no_page = ceil($total_records/$total_data_page);
                  $second_last = $total_no_page - 1;
                  $resultPerPage = $connection->query("SELECT * FROM tb_pengarang
              ...
              <?php  while($row = mysqli_fetch_assoc($resultPerPage)) : ?>
                  <tr>
                      ...
                      <td>
                        <a href="page_edit_pengarang.php?id=<?=$row['id_pengarang']?>"><button type="button" class="btn btn-warning">Edit</button></a>
                        <a href="hapus_pengarang.php?id=<?=$row['id_pengarang']?>"><button type="button" class="btn btn-danger">Hapus</button></a>
                      </td>
