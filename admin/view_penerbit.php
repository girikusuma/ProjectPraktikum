  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="container-fluid"> 
              <a href="page_tambah_penerbit.php">
          ...
          <section class="connectedSortable">
            <table class="table">
              ...
              <?php
                  ...
                  $next_page = $page + 1;
                  $prev_page = $page - 1;
                  $result = $connection->query("SELECT * FROM tb_penerbit");
                  $total_records = mysqli_num_rows($result);
                  $total_no_page = ceil($total_records/$total_data_page);
                  $second_last = $total_no_page - 1;
                  $resultPerPage = $connection->query("SELECT * FROM tb_penerbit
              ...
              <?php  while($row = mysqli_fetch_assoc($resultPerPage)) : ?>
                  <tr>
                      ...
                      <td>
                        <a href="page_edit_penerbit.php?id=<?=$row['id_penerbit']?>"><button type="button" class="btn btn-warning">Edit</button></a>
                        <a href="hapus_penerbit.php?id=<?=$row['id_penerbit']?>"><button type="button" class="btn btn-danger">Hapus</button></a>
                      </td>
